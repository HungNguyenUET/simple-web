...
create sequence GROUP_INFO_SEQ start 1 increment 1;
create sequence USER_GROUP_SEQ start 1 increment 1;
create sequence GROUP_SEQ start 1 increment 1;
...
VALUES (NEXTVAL('ROLE_SEQ'), 'Admin role', 'ADMIN');
INSERT INTO ROLES (ID, DESCRIPTION, NAME)
VALUES (NEXTVAL('ROLE_SEQ'), 'User role', 'USER');
INSERT INTO USERS (ID, EMAIL, PASSWORD, USER_NAME, DISPLAY_NAME, ACCESS_TOKEN, CREATED_DATE, UPDATED_DATE)
VALUES (NEXTVAL('USER_SEQ'), 'admin@fortna.com',
        '{JgZMrA8MGJ3E05evWWI5nbjFfk0Ms4C1P4rPFR4k8sM=}64354914afcc6eb99aa180519cb364e5', 'admin', 'Administrator', '',
        CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO USER_ROLE (ID, ROLE_ID, USER_ID)
VALUES (NEXTVAL('USER_ROLE_SEQ'), (SELECT ID FROM ROLES WHERE NAME = 'ADMIN'),
        (SELECT ID FROM USERS WHERE USER_NAME = 'admin'));
INSERT INTO LANGUAGES (ID, NAME)
VALUES (NEXTVAL('LANG_SEQ'), 'C++ 11');
INSERT INTO LANGUAGES (ID, NAME)
VALUES (NEXTVAL('LANG_SEQ'), 'JAVA 8');
